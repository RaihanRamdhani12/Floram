        ...
        <div class="container">
            <table class="table table-bordered border-dark table-striped">
                <thead class="table-dark">
                    <tr>
                        <th scope="col">ID buah</th>
                        <th scope="col">Nama buah</th>
                        <th scope="col">Harga buah</th>
                ...
                <tbody>
                    <?php foreach ($semua_jenis_buah as $list => $data_semua_buah) { ?>
                        <tr align="center">
                            <td><?= $data_semua_buah['id_jenis_buah'] ?></td>
                            <td><?= $data_semua_buah['nama_jenis_buah'] ?></td>
                            <td>Rp <?= number_format($data_semua_buah['harga'], 0, ',', '.'); ?></td>
                            <td><?= $data_semua_buah['gambar'] ?></td>
                            <td><a href="<?= base_url(); ?>/ubah_buah/<?= $data_semua_buah['id_jenis_buah'] ?>" class="btn btn-warning">Ubah Data</a></td>
                            <td><a href="<?= base_url(); ?>/hapus_buah/<?= $data_semua_buah['id_jenis_buah'] ?>" class="btn btn-danger">🗑️</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>

            <a class="btn btn-success" href="<?= base_url(); ?>/tambah_buah">Tambah Data</a>
