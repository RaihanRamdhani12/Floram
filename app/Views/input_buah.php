...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
            ...
            with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>/input_buah" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Input Buah</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>/brand/tambah_brand" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tambah Brand</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>/list_buah" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Buah</p>
                                    </a>
                                </li>
        ...
        <div class="container">
            <div class="card-body">
                <form action="<?= base_url(); ?>/input_buah_proses" method="post" enctype="multipart/form-data">
                    <label href="<?= base_url(); ?>/tengah.css" for="basic-url">Nama barang</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" id="nama_jenis_buah" name="nama_jenis_buah" aria-describedby="basic-addon3">
                    </div>

                    <label for="basic-url">Harga Buah</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" id="harga" name="harga" aria-describedby="basic-addon3">
                    </div>

                    <label for="basic-url">File Gambar </label>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="inputGroupFile01">Upload</label>
                        <input type="file" class="form-control" name="userfile" id="userfile">
                    </div>
                    <button class="button btn-primary"><span>Submit</span></button>
                </form>
            </div>
            <!-- /.content-wrapper -->
