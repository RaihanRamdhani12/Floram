                                            ...
                                            <div class="card-tools">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                        ...
                                                        <a href="<?= base_url(); ?>/" class="dropdown-item">Another
                                                            action</a>
                                                        <a href="<?= base_url(); ?>/" class="dropdown-item">Something
                                                            else here</a>
                                                        <a class="dropdown-divider"></a>
                                                        <a href="<?= base_url(); ?>/" class="dropdown-item">Separated
                                                            link</a>
                                                    </div>
                                                </div>
